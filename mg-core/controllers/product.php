  ...
  function __construct() {
    ...
    if ($product == null) {
     ...
     $propertyFormData = $model->createPropertyForm($param = array(
      ...
      //
      $product['propertyForm']=$product['thisUserFields'];
    ...
    // рекомендуемые товары  
      ...
      $relate = $model->getListByUserFilter('20', ' p.code IN ('.$stringRelated.') ');
      
      
       foreach ($relate['catalogItems'] as &$item) {
      ...
      $dataGroupProducts['relateProducts'] = $relateProducts;
    
      $relateProducts = $dataGroupProducts['relateProducts'];
      
      $product['related']=$relate['catalogItems'];
