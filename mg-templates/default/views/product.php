...
<!--
    ...
    <div class="product-code">  
      <p>
        <?php 
    foreach($data['propertyForm'] as $d){
       if($d['value']!='')
          {
           
         echo $d['name'].': '; 
         echo '<span class="label-article code">'.$d['value'].'</span>'; echo'</br>';
        ...
        <?php if(class_exists('rating')): ?>[rating id = "<?php echo $data['id'] ?>"]   <?php endif; ?>	</div>	
      </div>
    </div>
  ...
  <div class="product-details-wrapper">
    ...
    <div class="product-tabs-container">
      <div id="tab1" itemprop="description"><?php echo $data['description'] ?>
  ...
  <div class="m-p-products">
    <h1 style="text-align: center";><span>С ЭТИМ ТОВАРОМ ПОКУПАЮТ</span></h1>
    <div class="m-p-products-slider">
    <div class="<?php echo count($data['related'])>1?"m-p-products-slider-start":"" ?>">
